...
def format_yaml(obj):
    ...
    try:
        return safe_dump(obj.result, default_flow_style=False, allow_unicode=True)
        ...
        return safe_dump(json.loads(json.dumps(obj.result)), default_flow_style=False, allow_unicode=True)
